...
public interface IRestDocumentController {
    ...
    public RootEntity<Page<DtoDocument>> getActiveDocumentsByCompany(Long companyId, Pageable pageable);

    public RootEntity<Page<DtoDocument>> getArchivedDocumentsByCompany(Long companyId, Pageable pageable);
